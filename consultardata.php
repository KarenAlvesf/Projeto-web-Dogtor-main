    ...
    <div class="container p-3 mb-3" style="margin-top: 10vh;">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
          ...
          <div class="row">
            ...
            <div class="col-12">
                <form class="form col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex"  style="margin-top: 25px;margin-bottom: 25px;">

                    <input type="date" name="txtpesquisarUsuarios"  placeholder="Dia do agendamento" requerid/>
                    <button name="buttonPesquisar" class="btn btn-secondary" type="submit" style="margin-left: 15px;height: 50px;">Pesquisar
                    </button>
                 </form>
            </div>
            ...
            <?php 
               ...
               if(isset($_GET['buttonPesquisar']) and $_GET['txtpesquisarUsuarios'] != ''){
                  ...
                  /* ENTÃO VAI FAZER UM SELECT COMPARANDO COM O CAMPO DIA DO BANCO DE DADOS COM O CAMPO DIGITADO*/
                  $pagina = (isset($_GET['txtpesquisarUsuarios?pagina']))? $_GET['txtpesquisarUsuarios?pagina'] : 1; 
                  $query_count = "SELECT * from agenda where dia like '%$nome%' order by nome ";
                          ...
                          <table class="table">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col">Horário de data</th>
                                  <th scope="col">Dia</th>
                                </tr>
                              </thead>
                              <tbody>
